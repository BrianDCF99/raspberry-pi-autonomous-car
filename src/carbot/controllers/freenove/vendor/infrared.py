...
class Infrared:
    def __init__(self):
        ...
        self.sensors = {
            channel: LineSensor(pin) for channel, pin in self.IR_PINS.items()
        }
